// Ashima 3D simplex noise (mod289 / permute / taylorInvSqrt / snoise),
// shared verbatim by the terrain vertex shader and the atmosphere fragment
// shader. Both files used to carry their own identical copy; this is the one
// source of truth. Interpolate it into a shader string with `${SIMPLEX_3D}`.
//
